...
(Figure 3 in the draft and Figure 1 in the new version)
...
4. And for the head shape 
(supplementary in the draft? Figure 2 is new version)
...
5. Temperature table 
(supplimentary in the new version?)
