...
tempplot <-
  ...
  scale_colour_manual(values = c("orange1", "red", "cornflowerblue")) +
  # Add mean and se from pogsumA
  geom_point(data = pogsumA, aes(y = Temp_mean), size = 2) +
  geom_errorbar(data = pogsumA, aes(y = Temp_mean,
...
inctempplot <-
  ...
  scale_colour_manual(values = c("orange1", "red", "cornflowerblue")) +
  # Add mean and se from pogsumA
  geom_point(data = pogsumA, aes(y = IncTemp_mean), size = 2) +
  geom_errorbar(data = pogsumA, aes(y = IncTemp_mean,
