...
1. What is the range of bite forces?
...
4. And for the head shape (Figure 2)
...
Relative head width - scatterplot
...
RelHeadwidth <-
  ggplot(pogA, aes(x = Genotype, y = (HLroret/HWqu), 
                colour = Genotype, fill = Genotype)) +
  geom_jitter(alpha = 0.4, na.rm = TRUE, width = 0.2) +
  scale_colour_manual(values = c("orange1", "red", "cornflowerblue")) +
  # Add mean and se from pogsumA
...
5. Temperature table (supplementary)
...
6. Temperature plots (supplementary)
