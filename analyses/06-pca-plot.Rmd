...
ggsave(all, height = 7 , width = 7, filename = here("figures/pca-plots.png"))
```
...
ggsave(all, filename = here("figures/pca-plots-with_BF.png"))
```
...
#ggsave(all, filename = here("figures/pca-plots-withSVL.png"))
```
...
#ggsave(all, filename = here("figures/pca-plots-Adults-with_BF.png"))
```
