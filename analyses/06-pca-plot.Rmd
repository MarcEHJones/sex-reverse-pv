...
ggsave(all, filename = here("figures/pca-plots-ALL-shapes-adultsjuveniles.png"))
...
# provide combined panel  
# loadingsadults <- ggarrange(pc1, pc2, pc3, height = 7 , width = 7, common.legend = TRUE, #legend = "top", ncol = 1, nrow = 3)
# loadingsadults

#doesn't work. not sure why
#ggsave(loadingsall, height = 2 , width = 7, filename = here("figures/loadings-pca-plots-Adults.png"))  
...
#ggsave(all, height = 7 , width = 7, filename = here("figures/pca-plots-adults-shapes.png"))
```
