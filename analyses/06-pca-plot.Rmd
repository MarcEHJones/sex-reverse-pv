...
loadingsall <- ggarrange(pc1, pc2, pc3, height = 2 , width = 12, common.legend = TRUE, legend = "top", ncol = 1, nrow = 3)

loadingsall

#doesn't work. not sure why
#ggsave(loadingsall, filename = here("figures/loadings-pca-plots-ALL.png"))  
