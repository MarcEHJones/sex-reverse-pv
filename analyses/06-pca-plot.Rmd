...
#ggsave(all, height = 7 , width = 7, filename = here("figures/pca-plots-ALL-shapes3-bw.png"))
```
...
ggsave(all, height = 7 , width = 7, filename = here ("figures/pca-plots-Adults-with_BF-shapes.png"))
```
