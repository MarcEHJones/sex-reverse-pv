...
library(knitr)
library(here)
library(patchwork) # need to install from GitHub
library(ggConvexHull) # need to install from GitHub install_github("cmartin/ggConvexHull")
library(ggfortify)
library(car)
library(broom)
...
(pc12 + pc13) / (pc23 + plot_spacer())

ggsave(here("figures/pca-plots.png"))
```