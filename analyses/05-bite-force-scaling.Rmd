...
New combined BF vs LOG SVL and non LOG SVL colour plot for publication.
...
New combined BF vs LOG SVL and non LOG SVL black and white plot for publication.

```{r}
log_plot_bw / nl_plot_bw

ggsave(here("figures/figure3_new_twopanel_bw.png"))
```
