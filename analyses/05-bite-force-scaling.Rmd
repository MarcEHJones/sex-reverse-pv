...
#ggsave(here("figures/Figure4-bw.png"), height = 8 , width = 7)
...
This creates a plot of log(BF) vs log(Mass) Figure SI4
...
log(SVL) and log(bite force no lever) Figure SI 5
